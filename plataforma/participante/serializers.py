...
class ParticipanteSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ["id", "invitacion_aceptada", "invitacion_token"]
    ...
    def create(self, validated_data):
        ...
        existing_participante = Participante.objects.filter(usuario_id=usuario_id).first()
        if existing_participante:
            ...
            raise serializers.ValidationError("Este usuario ya está asociado a un participante existente.")

        # Crear el participante asociado al usuario
        participante = Participante.objects.create(usuario_id=usuario_id, **validated_data)
        return participante
